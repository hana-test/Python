# ---------- LEARN TO PROGRAM 9 ----------
#  created by Derek Banas - creating Educational Video Tutorials
# https://www.patreon.com/derekbanas 
# i just copy for learning perpose
...
# output
#  Properties provide a controlled way to access and modify object attributes.
# They maintain the illusion of direct attribute access while actually calling underlying methods.
# This allows for validation, derived attributes, and other logic within getters and setters.
